  ...
  window.addEventListener('load', function () {
    ...
    **/
    ...
    if (window.innerWidth > 945) {
      var promoSlider = document.querySelector('.promo-mentors__items.--slider');
      if (promoSlider) {
        var _swiper = new Swiper(promoSlider, {
          slidesPerView: 4,
          spaceBetween: 20,
          navigation: {
            nextEl: promoSlider.closest('.promo-mentors').querySelector('.promo-mentors__controll.--next'),
            prevEl: promoSlider.closest('.promo-mentors').querySelector('.promo-mentors__controll.--prev')
          }
        });
      }
    }
    if (window.innerWidth > 945) {
      var reviewsSlider = document.querySelector('.reviews__items.swiper-slider');
      if (reviewsSlider) {
        var _swiper2 = new Swiper(reviewsSlider, {
          slidesPerView: 3,
          spaceBetween: 20,
          navigation: {
            nextEl: reviewsSlider.closest('.reviews').querySelector('.promo-mentors__controll.--next'),
            prevEl: reviewsSlider.closest('.reviews').querySelector('.promo-mentors__controll.--prev')
          }
        });
      }
    }
    ...
    if (detailSlider) {
      var _swiper3 = new Swiper(detailNavSlider, {
        slidesPerView: 2,
        spaceBetween: 20
      });
      _swiper3 = new Swiper(detailSlider, {
        slidesPerView: 1,
        thumbs: {
    ...
    $('[data-play-vid]').on('click', function () {
      var $this = $(this),
    ...
    $('.discussions__form').on('submit', function (e) {
      e.preventDefault();
      ...
      $(this).parent().find('.discussions__form-success').addClass('--active');
      this.reset();
    });
    ...
    $('[name="deliveryType"]').on('change', function () {
      var $this = $(this),
        val = $this.val(),
        html = "\n            <div class=\"--prepended\">\n                <span class=\"order__form-type__field-name page-text-18\">\u0410\u0434\u0440\u0435\u0441 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438*</span>\n                <input type=\"text\" required name=\"address\" class=\"order__form-field\">\n            </div>\n            ";
      var $field = $('.order__form-type__field');
      if (val == 'Доставка') {
    ...
    $('.tours__item-body__select').selectmenu({
      change: function change(event, ui) {
        var $this = $(this),
          val = $this.val(),
          $parent = $this.parents('.tours__item-body__right'),
          $target = $parent.find('[data-price-content="' + val + '"]');
        $parent.find('[data-price-content]').hide();
        $target.show();
      }
    });
  });
